...
from scripts.utilitarios.gestion_conocimiento.buscarPorNumero import capa_filtro_numero_video,capa_filtro_numero_video_nuevo
...
#     print("Nueva consulta",nueva_consulta_usuario)
...
def cargar_todos_los_indices_nuevo(lista_indices=None):
    """
...
def elegir_mejor_chunck(pregunta: str,ultimo_bot: str, cantidad_chunks: int):
    ...
    # -- print de nueva consulta capa filtro
    print("Nueva consulta",nueva_consulta_usuario)
    print("Lista de videos", lista_indices)
